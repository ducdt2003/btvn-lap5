...
public class Tasks {
   ...
   private String taskDescription;
    ...
    private int workId;
    private int assignee; // người được giao nhiệm vụ
    private int workCreator; // người tọa công việc
    public Tasks() {
    }
    ...
    public int getWorkCreator() {
        return workCreator;
    }

    public void setWorkCreator(int workCreator) {
